                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="width:10%">Kode Pesanan</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="width:50%">Pelanggan</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" style="width:10%">Tanggal Pesanan</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="width:15%">Total Harga</th>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Pelanggan" name="pelanggan" id="pelanggan" style="width: inherit;" required>
                                </div>
                                <div class="input-group input-group-outline my-3">
                                    <label for="form-label">Tanggal Pesanan</label>
                                    <input type="date" name="tanggal_pesanan" id="tanggal_pesanan" class="form-control" style="width: inherit;" required>
                                </div>
                                <div class="input-group input-group-outline my-3">
                                    <label for="form-label">Total Harga</label>
                                    <input type="number" class="form-control" placeholder="Total Harga" name="total_harga" id="total_harga" style="width: inherit;" required>
                                </div>
...
</html><?php /**PATH /Volumes/Data/jobs/pesanan/resources/views/dashboard.blade.php ENDPATH**/ ?>