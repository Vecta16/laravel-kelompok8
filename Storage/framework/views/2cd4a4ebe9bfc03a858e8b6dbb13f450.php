...
<html lang="en">
  ...
  <body>
    ...
    <h3>Update data</h3>
         ...
         <form method="post" id="update" action="<?php echo e(route('dashboard.update', $pesanan->id_barang)); ?>">
                <?php echo csrf_field(); ?>
             ...
             <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode_pesanan" name="kode_pesanan" autocomplete="off"
                        value="<?php echo e($pesanan->nama_barang); ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="harga" name="harga" autocomplete="off"
                        value="<?php echo e($pesanan->harga); ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tanggal_pesanan" name="tanggal_pesanan" autocomplete="off"
                           value="<?php echo e($pesanan->tanggal_pesanan); ?>">
                
                <button type="submit" name="update" class="btn btn-warning">Update</button>
                 <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-danger mx-3">Kembali</a>
        </form>
...
</html><?php /**PATH /storage/ssd3/260/21931260/laravel/resources/views/edit.blade.php ENDPATH**/ ?>