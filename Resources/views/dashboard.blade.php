...
<body class="g-sidenav-show  bg-gray-200">
    ...
    @if($berhasil_hapus = Session::get('berhasil_hapus'))
    <script>
        Swal.fire({
            title: "Berhasil",
            text: "{{$berhasil_hapus}}",
    ...
    @elseif($berhasil_tambah = Session::get('berhasil_tambah'))
    <script>
        Swal.fire({
            title: "Berhasil",
            text: "{{$berhasil_tambah}}",
            icon: "success"
        });
    </script>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Tombol Update -->
                                                <a href="{{ route('dashboard.edit', $item->id_barang) }}" class="btn btn-warning text-white mb-2">
                                                    <i class="bi bi-pen-fill"></i> Update
                                                </a>
                                                
                                                <!-- Tombol Delete -->
                                                <form action="{{ route('dashboard.destroy', $item->id_barang) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <script>
        ...
        $('body').on('click', '.editPesanan', function() {
            var id = $(this).data('id');
            console.log(id);
            $.get("{{ route('dashboard.index') }}" + '/' + id + '/edit', function(data) {
